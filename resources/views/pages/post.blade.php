...
@section('content')
    <article class="post" data-id="{{ $post->post_id }}">
        ...
        <div id="votes">
            ...
            @else
                <h4 class="qtd-likes">Upvotes {{ $post->upvotes }}</h4>
                <h4 class="qtd-deslikes">Downvotes {{ $post->downvotes }}</h4>
            @endif
        </div>
                                ...
                                <article class="comment" data-comment-id="{{ $comment->comment_id }}">
                                    ...
                                    @if (Auth::check() && Auth::user()->user_id == $comment->owner->user_id)
                                        ...
                                        <div class="comment-votes">
                                            <span id="upvotes-{{ $comment->comment_id }}">Upvtes {{ $comment->upvotes ?? 0 }}</span>
                                            <span id="downvotes-{{ $comment->comment_id }}">Downvotes {{ $comment->downvotes ?? 0 }}</span>
                                        </div>
                                    @else
                                        <div class="comment-votes">
